...
public class VideoCaptureAndroid implements PreviewCallback, Callback {
  ...
  public synchronized void surfaceCreated(final SurfaceHolder holder) {
    ...
    if (camera == null || cameraThreadHandler == null) {
      Log.d(TAG, "VideoCaptureAndroid:surfaceCreated camera null or cameraThreadHandler null");
      return;
    }
    final Exchanger<IOException> result = new Exchanger<IOException>();
    cameraThreadHandler.post(new Runnable() {
  ...
  public synchronized void surfaceDestroyed(SurfaceHolder holder) {
    ...
    if (camera == null || cameraThreadHandler == null) {
      Log.d(TAG, "VideoCaptureAndroid:surfaceDestroyed camera null or cameraThreadHandler null");
      return;
    }
    final Exchanger<IOException> result = new Exchanger<IOException>();
    cameraThreadHandler.post(new Runnable() {
